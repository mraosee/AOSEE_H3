...
ws[25] = "الخال" -- msg
rs[25] = "هـذا الحــبيب🙄اخذ نص گلـبي وسحـرني بحبـه" -- reply
...
rs[31] = "الحمد لله زين فديـــت ربه 🙄😅"
...
ws[66] = "زوزايه" -- msg 
rs[66] = " هاي حبيبـة يسوري😻🙊ومعشـوقته 🙊هو گالي والله☝️😁مممممممح 💋💋💋" -- reply
...
ws[133] = "@AOSEE_TH" 
rs[133] = "فديت ربه 🙊 هذا مطور السورس العقرب😻❤️"
...
ws[238] = "هذا يا سورس" 
rs[238] = "سہورسہ ألعہقہربہ"

ws[239] = "مستر اوس" 
rs[239] = "فديت ربه 😍 هو الصنعني ⚙ من البنطرون 👖 للبدي 👕 فديته مطوري 🔩"

ws[240] = "الاصدار" 
rs[240] = "git clone https://github.com/mraosee/AOSEE_H3.git"

-- the main function
function aosee( msg, matches )
	...
	if ( msg.text == "about" ) then
		if ( msg.from.username == "Memo" ) then
			R = get_receiver(msg)
			send_large_msg ( R , "Made by @AOSEE_THT" );
		end
	end 
